...
TerraCommons uses Holochain's countersigning mechanism. A transfer atomically updates both parties' cryptographic records simultaneously, or updates neither. The transaction is mathematically self-consistent: it references the specific state of both records at the moment of transfer. Any attempt by Alice to transfer the same land twice would require her record to fork — to have two different histories from the same point — and that fork is immediately detectable by the network and triggers automatic alerts to the community. This is not a policy rule that can be ignored. It is an architectural property that cannot be circumvented without the circumvention being visible.
...
**The two-mode legitimacy strategy:** The legitimacy strategy above assumes an open-record deployment where the HTTP Gateway is publicly readable and the institutional approach is formal recognition. But the Governance Framework's Non-Negotiable 8 requires restricted gateway access in contexts where the government is an active adversary. This creates a paradox: institutional legibility requires openness; community safety may require restriction. These cannot both be optimised simultaneously.

TerraCommons therefore operates in two distinct legitimacy modes depending on deployment context:

*Recognition mode* — open HTTP Gateway, publicly readable records, institutional engagement with World Bank and national government land frameworks, strategic aim is formal legal recognition. This is the default mode for deployments in non-adversarial government contexts.

*Legal empowerment mode* — restricted gateway access, credentialed institutional partners only, institutional engagement with legal empowerment organisations, international human rights bodies, and diaspora networks. Strategic aim is strengthening communities' litigation and advocacy capacity rather than achieving formal recognition. This mode applies where Non-Negotiable 8 is triggered.

Every institutional conversation must make clear which mode a given deployment is operating in. TerraCommons should not present itself to World Bank partners as operating in recognition mode while actually restricting gateway access for safety reasons, or present itself to legal empowerment partners as operating in protection mode while pursuing formal government integration.

TerraCommons' honest value proposition without legal recognition is this: communities have a tamper-evident, internationally legible record of their claims and the evidence supporting them. That record is more durable than oral history, more credible than informally held paper documents, and more accessible to legal advocates, journalists, and international bodies than anything currently available to most of the communities who need it. It does not resolve disputes. It changes the evidentiary landscape in which disputes are fought. That is meaningful, and it is not nothing — but it must not be oversold.

**Counterweight:** The warning against overselling should not tip into underselling. "Changing the evidentiary landscape" is how a great deal of land restitution and human-rights litigation is actually won — documented, timestamped, multi-witness evidence set against an opponent's undocumented assertion (the Endorois proceedings being one regional example). In the hands of a competent advocate or a sympathetic court, a tamper-evident and independently verifiable record is frequently the decisive material, not a consolation prize for the absence of formal recognition. Better evidence changes who wins, not merely how the dispute is described.

There is a specific risk in underselling this caveat: a TerraCommons "Certified" stamp may make social fraud *more durable* than the informal arrangements it replaces. An oral claim can be challenged on its face. A TerraCommons certified claim carries the appearance of rigorous multi-validator consensus. If the validators who produced that consensus were bribed or coerced — and followed the protocol correctly while doing so — the certification increases the social and institutional cost of challenging the claim even though the underlying process was corrupt. A fraudulent certified claim is harder to dislodge than a fraudulent oral claim. Communities must understand this before they invest confidence in the certification process. The certified stamp is only as trustworthy as the governance process that produced it.

The same logic applies to the legal recognition question. A TerraCommons certified claim that turns out to be legally worthless in the community's jurisdiction is not a neutral outcome — it is a trap. A community that invested time, trust, and disclosure in a certification process, believing it provided meaningful protection, and then faces a developer with a government title deed and no TerraCommons record to show a court, is worse off than a community that never formalised its claims at all. The undocumented community knows its position is informal and acts accordingly. The TerraCommons community may believe its position is protected and be caught off-guard when it isn't. Communities must be told this risk plainly before registration begins, not after.

A specific version of this risk applies to compulsory acquisition. In Kenya and most other jurisdictions, governments hold statutory powers of compulsory acquisition that operate regardless of how well documented community land rights are. A TerraCommons record cannot block a government with compulsory acquisition authority from proceeding. It may strengthen a compensation claim, support a legal challenge to the acquisition process, or document prior occupation for advocacy purposes — but it does not provide a veto. Communities facing active development pressure, infrastructure projects, or resource extraction interest in their land must be told this explicitly. TerraCommons provides better evidence. It does not provide a shield.

This three-layer strategy is not optimistic about governments. It is designed to work even if the government layer never arrives — while positioning community land rights for eventual formal recognition when circumstances permit.
...
**Fraud at source.** A validator who falsely confirms a fraudulent claim is committing an accountable act that can be detected and proven after the fact. TerraCommons cannot read minds or prevent a bad actor from initially submitting a dishonest validation. It makes dishonest validation traceable, costly, and increasingly detectable as patterns accumulate over time.
